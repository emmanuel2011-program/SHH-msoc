...
export default function Page() {
        ...
        {step === 5 && (
          <>
            ...
            <div className="flex flex-col">
              ...
              <label className="border border-gray-300 rounded p-2 cursor-pointer flex items-center justify-between hover:bg-gray-100">
              <span>{formData.document ? formData.document.name : "Upload ID"}</span>
              <input
              type="file"
            ...
            function handlePassportUpload(e: React.ChangeEvent<HTMLInputElement>) {
  ...
  if (file.size > maxSize) {
    alert("File is too large. Max 1 MB allowed");
    return;
  }
