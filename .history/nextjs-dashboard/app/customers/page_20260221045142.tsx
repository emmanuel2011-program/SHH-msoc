...
export default function Page() {
  ...
  const validateStep = () => {
    const stepFields: Record<number, (keyof FormData)[]> = {
      ...
      4: ['spouseName','Spouse','spouseTitle','spouseDOB','spouseGender','spouseNationality','spouseStateOfOrigin','spouseLocalGovt','spouseMaritalStatus','spouseResidentialAddress'],
        ...
        {step === 4 && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <Input label="Spouse Mobile Phone" name="mobilePhone" pattern="^\+?\d{10,15}$" onBlur={updateField} />
