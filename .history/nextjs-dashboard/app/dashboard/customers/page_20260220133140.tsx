    ...
    <div className="max-w-5xl mx-auto p-6 bg-white shadow rounded space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="col-span-full">
              ...
              <label className="mr-4">
                <input type="radio" name="gender" value="Male" onChange={e => updateField('gender', e.target.value)} /> Male
              </label>
              <label>
                <input type="radio" name="gender" value="Female" onChange={e => updateField('gender', e.target.value)} /> Female
              </label>
            </div>
          </div>
        )}
        ...
        {step === 4 && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <Input label="Surname" name="spouseSurname" onBlur={updateField} />
              <Input label="First Name" name="spouseFirstName" onBlur={updateField} />
              <Input label="Middle Name (optional)" name="spouseMiddleName" onBlur={updateField} />
              <Input label="Date of Birth" type="date" name="spouseDateOfBirth" onBlur={updateField} />
              ...
              <Input label="Local Government Area" name="spouseLGA" onBlur={updateField} />
              <Input label="Marital Status" name="spouseMaritalStatus" onBlur={updateField} />
              <div className="col-span-full">
                <label className="block text-sm font-semibold">Gender</label>
                <label className="mr-4">
                  <input type="radio" name="spouseGender" value="Male" onChange={e => updateField('spouseGender', e.target.value)} /> Male
                </label>
                <label>
                  <input type="radio" name="spouseGender" value="Female" onChange={e => updateField('spouseGender', e.target.value)} /> Female
                </label>
              </div>
            </div>
          </>
        ...
        <div className="flex gap-4 mt-4">
          ...
          {step < 5 && <button type="button" className="px-4 py-2 bg-blue-500 text-white rounded" onClick={nextStep}>Next</button>}
